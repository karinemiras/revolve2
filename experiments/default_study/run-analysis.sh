...
screen -d -m -S knocks -L -Logfile ${outputs_path}/${study}/knocks.log python experiments/${study_path}/knockouts.py $study $experiments $tfs $runs $generations $outputs_path;
