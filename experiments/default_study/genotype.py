...
from revolve2.genotypes.cppnwin.modular_robot.geno_body_GRN_v3 import (random_v1 as grn_random)
...
# TODO: this is obsolete. cppnwin is not used anymore
class Genotype:
...
def mutate(
    ...
    return Genotype(
        mutate_body(genotype.body, rng),
        mutate_brain(genotype.brain, _MULTINEAT_PARAMS_BRAIN, innov_db_brain, multineat_rng),
