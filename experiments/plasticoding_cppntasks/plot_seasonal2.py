...
def plot_boxes(df_inner):
    ...
    for gen_boxes in gens_boxes:
        ...
        for env in env_conditions:
            ...
            df_inner_sub = df_inner[(df_inner['generation_index'] == gen_boxes)
            ...
            if df_concat is None:
                df_concat = df_inner_sub
            else:
                df_concat = pandas.concat([df_concat, df_inner_sub], axis=0)
        ...
        df_concat = df_concat.sort_values(by=['experiment', 'env_conditions_id'])
